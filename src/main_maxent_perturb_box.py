...
def calc_maxent(file_num, directory, perturb_prob=None, width=None):
    """
    ...
    if len(two_wayc) + len(three_wayc) + len(four_wayc) > 230:
    ...
    if width==None:
        ...
        print
        return (maxent_p, sum_prob_maxent_p)
    ...
    return (maxent_r, sum_prob_maxent_r)
...
def main(file_num):
    ...
    for p in perturb_prob:
        ...
        for w in width:
            tup = calc_maxent(file_num, directory, perturb_prob=p, width=w)
            maxent_dis_r.append(tup[0]) 
            sum_dis_r.append(tup[1])

        output = (maxent_dis_p, sum_dis_p, maxent_dis_r, sum_dis_r)
        # for real data
        # outfilename = '../output/realdata_maxent.pickle'
        # for synthetic data 
        # outfilename = '../output/d50_4_perturb_box/syn_maxent_expt'+str(file_num)+'_'+str(p)+'.pickle'
        # outfilename = '../output/d200_4_perturb_box/syn_maxent_expt'+str(file_num)+'_'+str(p)+'.pickle'
        outfilename = '../output/d250_10_perturb_box/syn_maxent_expt'+str(file_num)+'_'+str(p)+'.pickle'
        # outfilename = '../output/d350_15_perturb_box/syn_maxent_expt'+str(file_num)+'_'+str(p)+'.pickle'
        # outfilename = '../output/d500_20_perturb_box/syn_maxent_expt'+str(file_num)+'_'+str(p)+'.pickle'
