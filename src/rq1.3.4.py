...
def main(file_num=None, k=None, support=None, dataset_num=None):
    ...
    if dataset_num == None:
        ...
        outfilename = '../output/d'+str(k)+'/syn_maxent_expt'+str(file_num)+'_rfr.pickle'
    else:
        #with dataset 
        print("True distribution:" + str(read_prob_dist('../output_s'+str(dataset_num)+'/d'+str(k)+'/truedist_expt'+str(file_num)+'.pickle')))
        outfilename = '../output_s'+str(dataset_num)+'/d'+str(k)+'/syn_maxent_expt'+str(file_num)+'_rfr.pickle'
