'''
Python = 3.7 
matplotlib to plot single figure for testing 
'''
#PYTHON3 
import numpy as np
import pickle 
...
if __name__ == '__main__':
	...
	ax.plot(xvec, maxent_prob[0], 'r', label='maxent')
	ax.plot(xvec, emp_prob[0], 'b', label='empirical')
	ax.axis(plot_lims)
	ax.set_xticks(x_ticks)
	ax.set_title('KL Divergence =' + str(kl[0]) + '\nLambda = 2.4')
	plt.show() 
