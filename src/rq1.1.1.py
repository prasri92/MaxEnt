...
def main(file_num=None, k=None, support=None, dataset_num=None):
    ...
    tot_zeros, zv_nzemp, zv_zemp, nzv_zemp = opt.analyze_zero_atoms(cleaneddata)
    print()
    print('Total zero vectors:', tot_zeros)
...
if __name__ == '__main__':
    ...
    file_num = sys.argv[3]
    support = sys.argv[4]
    main(file_num=int(file_num), k=int(num_dis), support=float(support), dataset_num=int(dataset_num))
