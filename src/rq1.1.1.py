...
Objective: Calculate the number of zero vectors generated by the zero detection process, and see how many zero atoms 
are empirically zero, how many have been given values that are not etc
"""
...
if __name__ == '__main__':
    ...
    # including file number 
    # tot_zeros, zv_nzemp, zv_zemp, nzv_zemp, t = main(file_num = 2, k=int(num_dis), dataset_num=int(dataset_num))

    # without writing to file 
    for file_num in range(5):
        tot_zeros, zv_nzemp, zv_zemp, nzv_zemp, t = main(file_num = file_num+1, k=int(num_dis), dataset_num=int(dataset_num))

    # write to file
    # zeros_file = '../zero_analysis/dataset_s'+str(dataset_num)+'_d'+str(num_dis)+'_app.csv'
    # with open(zeros_file, "w") as csvFile: 
    #     first_row = ['#_diseases','file_num','tot_zeros','zv_nzemp','zv_zemp','nzv_zemp','t']
    #     csv.writer(csvFile).writerow(first_row)
    #     for file_num in range(5):
    #         tot_zeros, zv_nzemp, zv_zemp, nzv_zemp, t = main(file_num = file_num+1, k=int(num_dis), dataset_num=int(dataset_num))
    #         second_row = [int(num_dis), file_num+1, tot_zeros, zv_nzemp, zv_zemp, nzv_zemp, t]
