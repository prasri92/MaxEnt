    ...
    def solver_optimize(self):
        ...
        for i, partition in enumerate(parts):
            ...
            if len(partition) == 1:     # just use the MLE          
                ...
                #CHECK - REACHING CONVERGENCE IN INCREASING THE MAXIMUM FUNCTIONS IS OVERFITTING? 
                ...
                # optimThetas = minimize(func_objective, x0=initial_val, method='TNC',
                #     options={'disp':True, 'ftol':2.2e-10, 'maxiter':100000})
